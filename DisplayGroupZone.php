...
<table style="width: 30%">
    <tr>
        <td style="font-size: 16px; font-weight: bold">GroupName</td>
        <td><?php echo $GroupName;?></td>
    </tr>
    <tr>
        <td style="font-size: 16px; font-weight: bold">Department</td>
    ...
    <tr>
        <td style="font-size: 16px; font-weight: bold">PostalCode</td>
