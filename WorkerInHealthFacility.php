...
<div>
    ...
    <table border="4px" style="width: 100%">
        ...
        $db= mysqli_connect("fec353.encs.concordia.ca", "fec353_4","353y2021", "fec353_4","3306") or die ("fail");
        $query="Select FName,LName,DOB,Person.PhoneNo,Email from Person, PublicHealthCenter as HC,PublicHealthWorker as HW 
                    where HC.Name='$Facility' and HC.CenterID=HW.CenterID and HW.MediCare=Person.Medicare;";
        $record=mysqli_query($db,$query);
        while($data = mysqli_fetch_array($record))
        {
            ?>
