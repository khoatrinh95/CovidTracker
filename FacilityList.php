...
<div style="width: 70%; float: right; margin-right: 3%;margin-top: 3%">
    <h2 style="text-align: center">Health Facilities list</h2>
    <table border="4px" style="width: 100%">
        <tr style="font-size: 16px; font-weight: bold; height: 30px">
            <th>Facility Name</th>
            <th>Number of health worker</th>
            <th>Accept Patients methods</th>
        </tr>
        <?php
        $db= mysqli_connect("fec353.encs.concordia.ca", "fec353_4","353y2021", "fec353_4","3306") or die ("fail");
        $query ="Select HC.Name, count(MediCare), Accept_Patients from PublicHealthCenter as HC , PublicHealthWorker as HW  where HC.CenterID = HW.CenterID group by HC.Name ";
        ...
        ?>
            <tr style="height: 35px">
                ...
                <td><?php echo $data['count(MediCare)']; ?></td>
                <td><?php echo $data['Accept_Patients']; ?></td>
            </tr>
            <?php
        }
        ?>
