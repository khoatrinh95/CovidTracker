...
<div style="width: 70%; float: right; margin-right: 3%;margin-top: 3%">
    <P>
        <h3>Enter Main and Sub-Recommendations, leave sub blank if none</h3>
        <form action="" method="post">
            <div>
                <label>Main Recommendation</label>
                <input name="Main" type="text">
            </div>
            <div>
                <label>Sub Recommendation</label>
                <input name="Sub" type="text">
            </div>
            <div>
                <input name="submitInsert" type="Submit">
            </div>
            <?php
