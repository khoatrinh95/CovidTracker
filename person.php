...
$db= mysqli_connect("fec353.encs.concordia.ca", "fec353_4","353y2021", "fec353_4","3306") or die ("failsss");
$query="SELECT Medicare FROM Person where Medicare='$medicare'";
...
if(isset($_POST['Delete'])) {
    ...
    if ($result->num_rows==0){
        ...
        $deletequery ="DELETE FROM Person where Medicare='$medicare'";
        mysqli_query($db,$deletequery);
        $deleteparent="DELETE FROM Parents where PersonMedicare='$medicare'";
        mysqli_query($db,$deleteparent);

        echo "<script>
            alert('person with this Medicare Number has been delete it form the System');
            window.location.href='Person.html';
            </script>";
    }
}
...
if(isset($_POST['Edit'])) {
    ...
    if ($result->num_rows==0){
        ...
        echo "<script>
            window.location.href='editperson.php';
            </script>";
...
if(isset($_POST['Submit'])){
    ...
    $AddQuery="insert into Person values ('$FirstName','$LastName','$DOB','$Email','$Phone','$Medicare','$DoorNo',
    ...
    echo "<script>
          window.location.href='Person.html';
          alert('This person have been added successfully into the system');
          </script>";
}
if(isset($_POST['Save'])) {
    $Medicare = isset($_POST['Medicare']) ? $_POST['Medicare'] : '';
...
WHERE Medicare='$Medicare'";
    ...
    echo "<script>
          window.location.href='Person.html';
          alert('This person information has been updated successfully into the system');
          </script>";
}
...
if(isset($_POST['Display'])) {
    ...
    if ($result->num_rows==0){
        ...
        echo "<script>
            window.location.href='DisplayPerson.php';
            </script>";
